...
public class UserServiceImpl implements UserService {
    ...
    public void initializeDB() {
        ...
        User first = new User("", "", (byte) 8, "8", "1", Set.of(adminRole));
        User user = new User("admin", "Ivanov", (byte) 17, "admin@gmail.ru", "1", Set.of(adminRole));
        User admin = new User("user", "Petrov", (byte) 18, "user@mail.ru", "1", Set.of(userRole));
